# 차곡 (Chagok)
![메인 비주얼](https://github.com/user-attachments/assets/aafd4cfb-25d3-4f01-96f0-e5dbdaf38f90)
...
- 미래: 달성하고 싶은 목표 추가하기
- 과거: 저장된 모든 기억들 보기
- 하이라이트: CES 지수에 따른 통계 자료 생성(그래프) 
- CES 지수를 통한 AI 요약 보고서 생성

### 🧰 API
- CES 지수를 기반으로 현재 기억이 본인에게 어떤 의미를 주는지에 대한 리포트 생성 

### 시연 영상
|CES 점수에 따라 반응이 바뀌는 차곡이|
|:---:|
